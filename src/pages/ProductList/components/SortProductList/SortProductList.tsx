...
export default function SortProductList({ queryConfig, pageSize }: PropType) {
  ...
  return (
    <div className='bg-gray-200/40 px-3 py-4'>
          ...
          <div className='ml-2 flex'>
            {page === 1 ? (
              ...
              <Link
                ...
                className='flex h-8 w-9  items-center justify-center rounded-bl-sm rounded-tl-sm bg-white/60 px-3 shadow hover:bg-slate-100'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
