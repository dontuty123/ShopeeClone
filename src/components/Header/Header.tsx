              ...
              renderPopover={
                <div className='relative  ml-[-4rem] rounded-sm border border-gray-200  bg-white  shadow-md'>
                  <div className='flex flex-col items-start px-3 py-2'>
                    ...
                    <button onClick={handleLogout} className='mt-2 px-3  py-2 hover:text-orange'>
                      Đăng xuất
                    </button>
                  </div>
                </div>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
                className='flex-grow truncate border-none bg-transparent px-3 py-2 text-black outline-none'
              />
              <button className='flex-shrink-0 rounded-sm bg-orange px-4 py-1 hover:opacity-90 lg:px-6 lg:py-2'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
            ...
            >
              <Link to={path.cart} className='relative'>
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke='currentColor'
                  className='h-6 w-6 lg:ml-2 lg:h-7 lg:w-7'
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
